...
**AI Integration | Business Systems | Workflow Automation | AI Adoption**

I'm a technology and operations leader focused on turning fragmented, manual, and expertise-dependent work into structured systems that people can execute confidently.

I work at the intersection of:

**business problems + people + workflows + systems + AI + implementation**

My background combines operational leadership, customer-facing technology, networking, business systems, employee development, automation, and AI-assisted solution development.

I tend to approach problems from three perspectives:

### Operator
I understand the operational side of technology: customers, employees, budgets, vendors, service delivery, commercial decisions, deadlines, and what happens when systems fail in the real world.

### Integrator
I connect business requirements with workflows, software, APIs, automation, AI, and technical infrastructure.

### Coach
I care about whether the people using a system actually become more capable. Technology has not solved the problem if the organization remains dependent on the person who built it.
...
**Demonstrates:** AI adoption methodology, employee enablement, workflow harvesting, capability transfer, and continuous improvement.
...
| Evidence | Outcome |
|---|---|
| ConnectWise PSA transformation | 699 company records standardized and governed |
| Employee enablement | 14 technical and nontechnical users trained |
| Workflow improvement | Internal estimate of approximately 15 management hours/week returned |
| Nationwide network migration | 120+ locations, 650+ APs, 5 time zones |
| AI-assisted proposal workflow | 9 proposals representing $400K+ in five business days |
...
I do not assume AI belongs in every decision.

I prefer deterministic rules where outcomes should be predictable, AI where interpretation or synthesis creates real value, and human approval where judgment or authorization matters.
...
ConnectWise PSA · Microsoft 365 · SharePoint · Teams · Power Automate · REST APIs · JSON · HTTP · Webhooks
...
## Currently Building Deeper Capability In
...
**AI Integration · AI Adoption · Solutions Architecture · Business Systems · Workflow Automation · Technology Transformation**

The problems I find most interesting are usually between the technology and the people expected to use it:

- What should the workflow become?
- What should be automated?
- Where should AI be involved?
- Where should it not?
- What controls are necessary?
- How do we transfer capability to employees?
- How do we know the change actually improved the operation?

My goal is not simply to help organizations gain access to AI.
